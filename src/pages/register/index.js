        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              <CustomTextField autoFocus fullWidth sx={{ mb: 4 }} label={t('Username')} placeholder='johndoe' />
              <CustomTextField fullWidth label={t('Email')} sx={{ mb: 4 }} placeholder='user@email.com' />
              <CustomTextField
                fullWidth
                label={t('Password')}
