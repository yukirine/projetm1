...
//     min: 'Le mot de passe doit faire minimum ${min} caractères'
//   }
// })
...
const schema = yup.object().shape({
  email: yup.string().email("L'e-mail doit être une adresse valide").required('Le champ E-mail est obligatoire'),
  password: yup.string().min(5, `Le mot de passe doit faire minimum 5 caractères`).required()
})
