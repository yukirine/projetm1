  ...
  return (
    <Fragment>
      <ThemeProvider theme={theme}>
        ...
        >
          <Typography variant="h4" component="h2" sx={{ marginBottom: 2, fontSize: '1.8rem', fontWeight: 'bold', textAlign: 'center', }}>
            &nbsp;Aperçu journalier des pas
          </Typography>
          {/* Utilisation du Grid pour organiser les éléments horizontalement */}
          <Box sx={{ display: "flex", flexWrap: "wrap", width: '100%', height: '100%', justifyContent: "space-evenly" }}>
            ...
            <Box
              sx={{
                ...
                display: 'flex',
                flexDirection: {
                  xs: 'row', // Flex direction as row on extra-small screens
                  sm: 'row', // Flex direction as row on small screens
                  md: 'column', // Flex direction as column on medium and larger screens
                },
                '& > *': {
                  paddingY: {
                    md: '2rem'
                ...
                '& > *:not(:last-child)': {
                  borderBottom: {
                    md: '1px solid #ccc', // Border bottom on medium and larger screens
                  },
                  borderRight: {
                    xs: '1px solid #ccc', // Border right on extra-small screens
                    sm: '1px solid #ccc', // Border right on small screens
                    md: 'none', // No border right on medium and larger screens
                  },
                },
              }}
            >
              <Box>
                ...
                <Box sx={{ color: '#baffc9', fontSize: { xs: '1rem', md: '1.5rem' }, fontWeight: 'bold' }}>
                  <svg width="3vh" height="3vh" viewBox="-33 0 255 255" xmlns="http://www.w3.org/2000/svg">
                    <g id="fire">
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ fontSize: { xs: '1rem', md: '1.5rem' }, fontWeight: 'bold' }}>500</Box>&nbsp;cal
                </Box>
              </Box>
              <Box>
                <Box sx={{ color: '#ffb3ba', fontSize: { xs: '1rem', md: '1.5rem' }, fontWeight: 'bold' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="3vh" height="3vh" viewBox="0 0 256 256" preserveAspectRatio="xMidYMid">
                    <defs>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ fontSize: { xs: '1rem', md: '1.5rem' }, fontWeight: 'bold' }}>3.2</Box>&nbsp;km
                </Box>
              </Box>
              <Box>
                <Box sx={{ color: '#bae1ff', fontSize: { xs: '1rem', md: '1.5rem' }, fontWeight: 'bold' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="3vh" height="3vh" viewBox="-1 0 255 255" preserveAspectRatio="xMidYMid">
                    <g id="sneakers">
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ fontSize: { xs: '1rem', md: '1.5rem' }, fontWeight: 'bold' }}>7000</Box>&nbsp;pas
            ...
            <Box sx={{
              width: {
                ...
                md: '60%', // Auto width on medium and larger screens
              },
              maxHeight: "50vh"
            }}>
