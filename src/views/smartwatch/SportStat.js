  ...
  const dataPoints = [
    {
      label: 'Durée', value: '45 min', color: '#7ACF87', svgPath:
        (<svg xmlns="http://www.w3.org/2000/svg" width="4vh" height="4vh" viewBox="0 0 24 24" enable-background="new 0 0 24 24" version="1.1" >
    ...
    }, // Flame icon for calories
    {
      label: 'Fréquence Cardiaque', value: '140 bpm', color: '#4CA7D9', svgPath: (
        <svg xmlns="http://www.w3.org/2000/svg" height="4vh" width="4vh" viewBox="0 0 512.001 512.001">
      ...
      <Box sx={{
        ...
        {dataPoints.map((data, index) => (
          <Box key={index} sx={{
            ...
            <Typography variant="h6" component="p" sx={{ color: 'white', mt: 1, fontSize: "1.5vh" }}>
              &nbsp;{data.value}
            </Typography>
          </Box>
        ))}
